    ...
    <div className={cn("relative overflow-hidden group rounded-sm shadow-sm hover:shadow-royal transition-all duration-700", feature.span)}>
        <Link href={feature.href} className="block h-full w-full">
            <div className="relative h-full w-full aspect-[4/5] md:aspect-auto">
                ...
                <div className="absolute bottom-0 left-0 p-4 md:p-5 w-full transform translate-y-1 group-hover:translate-y-0 transition-transform duration-500">
                    <p className="text-antique-gold text-[8px] tracking-[0.4em] font-medium uppercase mb-0.5">{feature.subtitle}</p>
                    <h3 className="text-white text-lg md:text-xl font-heading mb-3 leading-tight font-medium">{feature.title}</h3>
...
export const FeatureGrid = () => {
    return (
        <section className="relative container-custom py-12 border-y border-ash-brown/5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 md:grid-rows-2 gap-3 h-auto md:h-[480px]">
